...
**Task 1.a:** Describe the technique(s) used to find and confirm the presence of the vulnerability. As a proof-of-concept exploit, log into the website and submit a JavaScript payload that attempts to generate an alert box containing the authenticated user's cookie data. Were you able to obtain the user's cookie with JavaScript? Explain why or why not. Include screenshots of exploitation and snippets of relevant, vulnerable source code.
